...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    parcelV10AuthUserSubject.add(
      ParcelV10AuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<ParcelV10AuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  ParcelV10AuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = ParcelV10AuthUser(
      loggedIn: true,
      uid: authUid,
    );
    parcelV10AuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
