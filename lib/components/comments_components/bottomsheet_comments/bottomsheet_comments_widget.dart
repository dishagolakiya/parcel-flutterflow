...
import 'bottomsheet_comments_model.dart';
export 'bottomsheet_comments_model.dart';
...
class _BottomsheetCommentsWidgetState extends State<BottomsheetCommentsWidget> {
  late BottomsheetCommentsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BottomsheetCommentsModel());
