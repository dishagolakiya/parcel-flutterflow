...
import 'comment_tile_model.dart';
export 'comment_tile_model.dart';
...
class _CommentTileWidgetState extends State<CommentTileWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CommentTileModel());
  }
              ...
              Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: const BoxDecoration(),
                    child: Text(
                      'Amazing! So glad I took the chance with parcel !',
