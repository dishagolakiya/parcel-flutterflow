                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      ...
                      _model.createProfileAPIResult =
                        ...
                        profilePic: _model.profilePicChanged
                            ? _model.uploadedLocalFile
                            : null,
                      );

                      shouldSetState = true;
                      if ((_model.createProfileAPIResult?.succeeded ?? true)) {
                        FFAppState().accessToken = widget.accessToken!;
                        FFAppState().refreshToken = widget.refreshToken!;
                        GoRouter.of(context).prepareAuthEvent();
                        await authManager.signIn(
                          authenticationToken: widget.accessToken,
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                            content: Text(
                              (_model.createProfileAPIResult?.jsonBody ?? '')
                                  .toString(),
                              style: TextStyle(
