    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        body: Column(
          ...
          children: [
            if (widget.pageType == 'Subscribers')
              Padding(
              ...
              child: ListView(
                ...
                children: [
                  wrapWithModel(
                    ...
                    child: FollowerRowWidget(
                      statusValue: widget.pageType,
                    ),
                  ),
                  wrapWithModel(
                  ...
                  wrapWithModel(
                    model: _model.followerRowModel9,
                    updateCallback: () => safeSetState(() {}),
                    child: const FollowerRowWidget(),
                  ),
                  wrapWithModel(
                    model: _model.followerRowModel10,
                    updateCallback: () => safeSetState(() {}),
                    child: const FollowerRowWidget(),
                  ),
                  wrapWithModel(
                    model: _model.followerRowModel11,
                    updateCallback: () => safeSetState(() {}),
                    child: const FollowerRowWidget(),
                  ),
                  wrapWithModel(
                    model: _model.followerRowModel12,
                    updateCallback: () => safeSetState(() {}),
                    child: const FollowerRowWidget(),
                  ),
                  wrapWithModel(
                    model: _model.followerRowModel13,
                    updateCallback: () => safeSetState(() {}),
                    child: const FollowerRowWidget(),
                  ),
                  wrapWithModel(
                    model: _model.followerRowModel14,
                    updateCallback: () => safeSetState(() {}),
                    child: const FollowerRowWidget(),
                  ),
